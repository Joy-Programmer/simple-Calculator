...
public class Matrix_Multiplication extends JFrame{
    ...
    int r1,r2,c1,c2,n=0,i=0,j=0,k=0,l=0,condition=1,number3=0,p=0,q=0,number4=0,number5=0;
    ...
    panel3.add(button2);
     ...
     button2.addActionListener(new ActionListener() {
            ...
            if(number3==1) {if( condition==0){
             ...
             jtext1.append("7");}
            else jtext1.setText("Give upper values and press Enter");
            } 
        ...
        jbox1.setEnabled(true);
          ...
          button3.setEnabled(true);
           button2.setEnabled(true);
            ...
            number3=0;i=0;j=0;k=0;l=0;number4=0;number5=0;
            jtext1.setText("");
            jtext2.setText("");
            } 
