...
public class Calculator_Structure extends JFrame{
   Container c,c2;
   JTextArea jtext1;
  String first_operator= null, second_operator=null;
   double fnum,lnum,result,radian; 
   int oprator=0,number=0,num2=0,number2;
    ImageIcon icon1;
    ...
    button15.addActionListener(new ActionListener() {
     ...
     button16.addActionListener(new ActionListener() {
            ...
            try{ 
                ...
                if(number==0){  jtext1.setText("Syntax error");}
                     ...
                     switch (oprator) {
                         ...
                         case 3:
                             ...
                             case 4:
                             {
                                result=fnum / lnum;
                                 String s= String.valueOf(result);
                                 if(s=="Infinity" || s=="NaN"){jtext1.setText("Infinity");}
                                 else{jtext1.setText("");
                                 jtext1.append("("+f+") / ("+l+") = \n"+s);;
                                 }}
